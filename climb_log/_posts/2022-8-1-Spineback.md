...
The approach was about 3.5km from the Island Lake Lodge (which is about 25 minutes from downtown) and has about 600m of elevation gain.
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackTrailMap.png" width="500">&nbsp;
</p>
The approach didn't take too long. I would guess it took about an hour and a half? Note: Justin and I were #wrecked from our 56km Rockwall run two days prior so the time estimate may not be correct. Anyway - to approach, we took the Spineback trail until we got to the Goldilocks intersection and went left onto Goldilocks.
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackGoldilockIntersection.jpg" width="350">&nbsp;
</p>
About 200m down the Goldilocks trail, we saw a small climbers trail to the left of the buttress.
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackApproach.jpg" width="350">&nbsp;
</p>
You'll see that you have arrived at the start of the climb when you see bolts + a beautiful runnel running down pitch 2.
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackStartOfClimb.jpg" width="350">&nbsp;
  Scenic photo
</p>
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackRappel.jpg" width="350">&nbsp;
  Base of climb
</p>
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackTopOfPitch2.jpg" width="700">&nbsp;
...
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackSummit.jpg" width="350">&nbsp;
  Spineback summit horn + Justin
</p>

Enjoy some lovely Fernie alpine views!
<p align="center">
  <img src="{{ site.baseurl }}/bike_log/images/Aug22/FernieSpineback/SpinebackFernieAlpine.png" width="700">&nbsp;
</p>
